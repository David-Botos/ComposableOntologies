...
<aside style="margin:0 0 2.4rem;border:1px solid rgba(242,236,218,0.16);border-left:3px solid #8fe6a4;border-radius:4px;background:#131513;padding:1.2rem 1.4rem;">
  <div style="font-family:'JetBrains Mono', ui-monospace, 'SF Mono', monospace;font-size:0.72rem;letter-spacing:0.08em;text-transform:uppercase;color:#8fe6a4;margin-bottom:0.7rem;">TL;DR</div>
...
<figure style="margin:1.8rem 0;display:grid;grid-template-columns:repeat(auto-fit,minmax(min(100%,240px),1fr));gap:1rem;">
  <div style="border:1px solid #4f7d5f;border-radius:4px;background:rgba(143,230,164,0.05);padding:1.2rem;">
    <div style="font-family:'JetBrains Mono', ui-monospace, 'SF Mono', monospace;font-size:0.75rem;letter-spacing:0.08em;text-transform:uppercase;color:#8fe6a4;margin-bottom:0.7rem;">Merge</div>
    <div style="font-family:'JetBrains Mono', ui-monospace, 'SF Mono', monospace;font-size:1.1rem;color:#f2ecda;line-height:1.5;">A&nbsp;●&nbsp;&nbsp;&nbsp;B&nbsp;●&nbsp;&nbsp;→&nbsp;&nbsp;<span style="color:#8fe6a4;">●</span></div>
    <p style="margin:0.7rem 0 0;font-size:0.9rem;color:#cbc6b6;">Same thing, one node. Entity resolution / dedup. <strong style="color:#f2ecda;">Unification fits.</strong></p>
  </div>
  <div style="border:1px solid rgba(242,236,218,0.16);border-radius:4px;background:rgba(126,199,216,0.05);padding:1.2rem;">
    <div style="font-family:'JetBrains Mono', ui-monospace, 'SF Mono', monospace;font-size:0.75rem;letter-spacing:0.08em;text-transform:uppercase;color:#7ec7d8;margin-bottom:0.7rem;">Link</div>
    <div style="font-family:'JetBrains Mono', ui-monospace, 'SF Mono', monospace;font-size:1.1rem;color:#f2ecda;line-height:1.5;">A&nbsp;●&nbsp;<span style="color:#7ec7d8;">—closes→</span>&nbsp;B&nbsp;●</div>
    <p style="margin:0.7rem 0 0;font-size:0.9rem;color:#cbc6b6;">Distinct things, typed edge. Stay separate. <strong style="color:#f2ecda;">Wants a graph.</strong></p>
  </div>
</figure>
...
<figure style="margin:1.8rem 0;display:grid;gap:0.5rem;">
  <div style="border:1px solid #4f7d5f;border-left:3px solid #8fe6a4;border-radius:4px;background:rgba(143,230,164,0.05);padding:1rem 1.2rem;">
    <div style="font-family:'JetBrains Mono', ui-monospace, 'SF Mono', monospace;font-size:0.72rem;letter-spacing:0.08em;text-transform:uppercase;color:#8fe6a4;">Layer 1 · Define</div>
    <div style="color:#f2ecda;margin-top:0.2rem;">Schema / constraint layer — each domain's shapes, composed by <em>unifying</em> constraints.</div>
  </div>
  <div style="border:1px solid rgba(242,236,218,0.16);border-left:3px solid #7ec7d8;border-radius:4px;background:rgba(126,199,216,0.05);padding:1rem 1.2rem;">
    <div style="font-family:'JetBrains Mono', ui-monospace, 'SF Mono', monospace;font-size:0.72rem;letter-spacing:0.08em;text-transform:uppercase;color:#7ec7d8;">Layer 2 · Relate</div>
    <div style="color:#f2ecda;margin-top:0.2rem;">Graph as relational backbone — typed cross-domain <em>links</em>, validated against layer 1, never merged into it.</div>
  </div>
  <div style="border:1px solid rgba(230,181,103,0.4);border-left:3px solid #e6b567;border-radius:4px;background:rgba(230,181,103,0.05);padding:1rem 1.2rem;">
    <div style="font-family:'JetBrains Mono', ui-monospace, 'SF Mono', monospace;font-size:0.72rem;letter-spacing:0.08em;text-transform:uppercase;color:#e6b567;">Layer 3 · Operate</div>
    <div style="color:#f2ecda;margin-top:0.2rem;">Agent / workflow layer — extraction, orchestration, and the rules that grow the graph. Reads and writes the graph; doesn't define what's valid.</div>
  </div>
</figure>
